...
namespace Simpledb {
	...
	*/
	...
	public:
		...
		*/
		void insertTuple(const TransactionId& tid, int tableId,const Tuple& t);// not necessary for lab1
		/**
		...
		*/
		void deleteTuple(const TransactionId& tid, const Tuple& t);// not necessary for lab1
		/**
